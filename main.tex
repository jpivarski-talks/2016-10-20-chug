...
\date{\textcolor{darkblue}{Chicago Hadoop User Group (CHUG) \\ October 20, 2016}}
...
\item<3-> LHC today: $\sim$25~PB per year
...
\begin{frame}{Probably the same rooms}
\vspace{0.5 cm}
\begin{columns}
\column{0.5\linewidth}
\mbox{ } \hfill SPS in 1980's: $\sim$100~GB per year \hfill \mbox{ }

\vspace{0.3 cm}
\includegraphics[width=\linewidth]{tapes1.png}
\column{0.5\linewidth}
\mbox{ } \hfill LHC today: $\sim$25~PB per year \hfill \mbox{ }
...
\begin{frame}{Want to get involved?}
\begin{center}
\uncover<2->{\textcolor{darkblue}{\small \mbox{\hspace{-1 cm}Contact} me at {\tt \textbf{jpivarski@gmail.com}} or through \mbox{\tt \textbf{http://github.com/histogrammar}\hspace{-1 cm}}}}
